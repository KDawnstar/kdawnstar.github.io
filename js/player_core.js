...
const PlayerManager = {
    init: function(playerData, actionData, gameState) {
        ...
        gameState.player = {
            ...
            meleeWeaponRenderColor: pd.Melee_Weapon_Render_Color || null,
            rangeWeaponRenderType: pd.Range_Weapon_Render_Type || null,
            rangeWeaponRenderColor: pd.Range_Weapon_Render_Color || null,
            stance: 'Mode_Melee', faceDir: 1, state: 'Idle',
            hitSpeed: parseFloat(pd.Hit_Anim_Speed) || 1.0, hitDur: (parseFloat(pd.Hit_Anim_Duration) || 0.2) / (parseFloat(pd.Hit_Anim_Speed) || 1.0), 
